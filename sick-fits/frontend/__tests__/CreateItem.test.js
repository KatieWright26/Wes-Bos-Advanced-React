...
const dogImage = 'https://dog.com/image.jpg';
...
describe('<CreateItem/>', () => {
  ...
  it('it handles state updating', async () => {
    const wrapper = mount(
      <MockedProvider>
        <CreateItem />
      </MockedProvider>
    ...
    wrapper.find('#price').simulate('change', {
      target: { value: 100000, name: 'price', type: 'number' },
    });
    wrapper.find('#description').simulate('change', {
      target: { value: 'This is a product', name: 'description' },
    });
